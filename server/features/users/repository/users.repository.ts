...
function ensureInitialized(): void {
  ...
  statements = {
    ...
    getUserSchools: db.prepare('SELECT s.* FROM schools s INNER JOIN user_schools us ON s.id = us.schoolId WHERE us.userId = ? ORDER BY s.name'),
