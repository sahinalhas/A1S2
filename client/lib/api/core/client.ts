...
class ApiClient {
 ...
 // Add school header interceptor for multi-school support
 this.interceptors.addRequestInterceptor(createSchoolHeaderInterceptor());
 }
